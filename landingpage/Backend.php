...
$password = "Monica@3214";        // Database password
$dbname = "met-website-backend";  // Database name
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $utm_params = json_encode($utm_params);

    // SQL query to insert data
    $stmt = $conn->prepare("INSERT INTO forms (form_name, form_params, utm_params, api_response, created_at, updated_at) VALUES (?, ?, ?, ?, NOW(), NOW())");

    $form_name = "landingpage";
    $api_response = NULL;

    $stmt->bind_param("ssss", $form_name, $form_params, $utm_params, $api_response);
