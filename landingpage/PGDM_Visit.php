...
if((isset($_POST['Apply']) || isset($_POST['Register'])))
    {
...
//eduworld lms data
	...
	$tdata['name']=$tName['Fname']." ".$tName['Lname'];
    ...
    $tdata['city']=isset($_POST['txtCity']) && $_POST['txtCity']!='' ? $_POST['txtCity'] : '' ;
    $tdata['qualification']=isset($_POST['ddQuali']) && $_POST['ddQuali']!='' ? $_POST['ddQuali'] : '' ;
	$tdata['programme_name']='PGDM (e-Business)' ;
    $tdata['extraegde_id']='11';
	$tdata['course_id']='46' ;
...
//send lms data to eduworld
   ...
   parse_str($tdata['utm_param'], $query);
    ...
    $tdata['utm_source']        = 'Apply from Website';
    ...
    $tdata['fbclid']       = isset($query['fbclid'])      ? $query['fbclid']     : '';
    $tdata['gclid']       = isset($query['gclid'])      ? $query['gclid']     : '';
    ...
    header('Location:PGDM_Res.php');    
    exit();

    }
else
    {
    header('Location:PGDM.php');
    } 
